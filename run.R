...
#print(args)
#args <- c("/gpfs_home/dscott3/code/beests-hack/examples/example_data_group.csv", "/gpfs_home/dscott3/code/beests-hack/examples/",  "/gpfs_home/dscott3/code/beests-hack/examples/example_data_group/analysis.txt")

data.file = args[1]
path_analysisDir = args[2]
path__analysisDescription = args[3]
